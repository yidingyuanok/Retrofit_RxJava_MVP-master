 ...
 * by y on 2016/4/29.
 */
public class ImageDetailPresenterImpl extends Base4ViewPresenterImpl<BaseView.ImageDetailView>
        implements Presenter.ImageDetailPresenter, DataListener.ImageDetailData {
    ...
    @Override
    public void permission(int requestCode, int[] grantResults) {
    ...
    @Override
    public void onSuccess(List<ImageDetailInfo> imageDetailInfo) {
        mView.setData(imageDetailInfo);
    }
